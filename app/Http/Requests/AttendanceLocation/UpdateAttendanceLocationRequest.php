...
class UpdateAttendanceLocationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // "qr_secret" cũng không cho sửa tay qua form — đổi bằng cách xóa
            // rồi tạo lại điểm chấm công mới (giống đổi mật khẩu, không có
            // luồng "sửa bí mật" riêng để tránh vô tình lộ giá trị cũ).
