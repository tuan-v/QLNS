...
Project sử dụng Laravel 12, Vue 3, MySQL và Redis. Trong quá trình phát triển, hai tài liệu nguồn tại thư mục `docs/` là căn cứ bắt buộc cho mọi thay đổi chức năng và nghiệp vụ.
...
- Bản đồ mã nguồn (tính năng nằm ở file nào): [`CODE_MAP.md`](CODE_MAP.md)
